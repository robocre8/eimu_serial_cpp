...
```shell
wget https://github.com/robocre8/eimu_serial_cpp/releases/download/v1.3.0/eimu-serial-dev_1.3.0_arm64.deb
```
```shell
sudo apt install ./eimu-serial-dev_1.3.0_arm64.deb
```
